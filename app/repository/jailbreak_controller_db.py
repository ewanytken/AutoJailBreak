...
from app.repository import DatabaseInterface, DatabaseService


class JailBreakControllerDB:
    ...
    def __init__(self, db_connection: DatabaseInterface):
        ...
        self.db_service = DatabaseService(db_connection)
    ...
    def register_request(self):
        ...
        def auto_jailbreak(json = Body()):
            self.db_service.add_dialog("{}".format(json))
